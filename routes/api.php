...
Route::prefix('usuario')->group(function(){
    Route::post('registar-se', [App\Http\Controller\UsuarioController::class, 'registrar']);
    ...
    Route::post('desartivar-conta', [App\Http\Controller\UsuarioController::class, 'desativarConta']);
