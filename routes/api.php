...
Route::prefix('usuario')->group(function(){
    Route::post('registar-se', [App\Http\Controllers\UsuarioController::class, 'registrar']);
    ...
    Route::post('desartivar-conta', [App\Http\Controllers\UsuarioController::class, 'desativarConta']);
